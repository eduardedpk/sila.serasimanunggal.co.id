...
else 
{
    ...
    if(isset($_GET['Action']))
    {
                ...
                <body class="fixed-left">
                            ...
                            <div class="content">
                                ...
                                {   
                                    if(!isset($_SESSION['Tanggal_Laporan']))
                                    {
                                        ...
                                        $Periode_Laporan = $_SESSION['Tanggal_Laporan'];
                                    }
                                    else
                                    {
                                        $Periode_Laporan = $_SESSION['Tanggal_Laporan'];
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="panel">
                                            <div class="panel-body table-responsive">
                                                ...
                                                {
                                                    ?>
                                                    <p><a href="kpi_ho.php?Action=Dokumen_Tambah" class="btn btn-info" title="Klik untuk menambah data"><i class="fa fa-plus"></i> Data</a></p>
                                                    <?php
                                                }
                                                else
                                                {
                                                        ...
                                                        while($buff_Data_Siswa = mysqli_fetch_array($qry_Data_Siswa))
                                                        {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align:left">
                                                                    <a href="kpi_ho.php?Action=Dokumen_Update&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>"><i class="ti-pencil" title="Update data"></i></a>
                                                                    <a href="kpi_ho.php?Action=Dokumen_Hapus&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>" style="color:red;padding-left:10px" title="Hapus data"><i class="ti-trash"></i></a>
                                                                </td>
                                                            </tr>
                                                            <?php
                                                            $Nomor_Urut++;
                    ...
                    <script>
                        function CekWaktu() 
                        {
                            ...
                            window.location.href="kpi_ho.php?Action=Daftar&Periode="+Periode;
                        }
                        function CekCabang() 
                        {
                            var Cabang = document.getElementById("inputCabang").value;
                            
                            window.location.href="kpi_ho.php?Action=Daftar&Cabang="+Cabang;
                        }
                ...
                <body class="fixed-left">
                                ...
                                <div id="sidebar-menu">
                                    ...
                                    if($Hak_Akses==1) //Administrator
                                    {
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="kpi_ho.php?Action=Daftar" class="waves-effect"><i class="ti-back-left"></i><span> Kembali </span></a>
                                            </li>
                                        </ul>
                                        <?php
                                    }
                                    ...
                                    <div class="container">
                                        <div class="panel">
                                            <div class="panel-body table-responsive">
                                                ...
                                                {
                                                    ?>
                                                    <p><a href="kpi_ho.php?Action=Dokumen_Detail_Tambah&Tanggal=<?php echo $Tanggal_Laporan ?>" class="btn btn-info" title="Klik untuk menambah data"><i class="fa fa-plus"></i> Data</a></p>
                                                    <?php
                                                }
                                                else
                                                {
                                                            ...
                                                            <tr>
                                                                ...
                                                                if($Hak_Akses==2)
                                                                {
                                                                    ...
                                                                    <td style="text-align:center">
                                                                        <a href="kpi_ho.php?Action=Dokumen_Valid&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>"><i class="fa <?php echo ($IsValid==1)?"fa-check":"fa-times" ?>"></i></a>
                                                                    </td>
                                                                    <?php
                                                                }
                                                                else
                                                                {
                                                                    ?>
                                                                    <td style="text-align:center">
                                                                        <a href="kpi_ho.php?Action=Dokumen_Detail_Update&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>"><i class="fa fa-pencil"></i></a>
                                                                        <a href="kpi_ho.php?Action=Dokumen_Detail_Hapus&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>" title="Hapus laporan"><i class="fa fa-trash"></i></a>
                                                                    </td>
                                                                    <?php
                                                                }
                    ...
                    <script>
                        function CekWaktu() 
                        {
                            ...
                            window.location.href="kpi_ho.php?Action=Daftar&Tanggal="+Tanggal;
                        }
        ...
        elseif($_GET['Action']=='Dokumen_Detail_Hapus')
        {
            ...
            $_SESSION['Parrent_Page'] = 'kpi_ho.php?Action=Daftar';
            ?>
            <!DOCTYPE html>
            <html>
                <head>
                            ...
                            <div class="sidebar-inner slimscrollleft">
                                ...
                                <div id="sidebar-menu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="kpi_ho.php?Action=Detail_Laporan&Tanggal=<?php echo $Tanggal_Laporan ?>" class="waves-effect"><i class="ti-back-left"></i><span> Kembali </span></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="clearfix"></div>
                                    ...
                                    <div class="container">
                                        <div class="panel">
                                            <div class="panel-body">
                                                <form class="form-horizontal" name="form_tambah" action="kpi_ho.php" method="post" enctype="multipart/form-data">
        ...
        elseif($_GET['Action']=='Dokumen_Update' || $_GET['Action']=='Dokumen_Tambah')
        {
            ...
            else
            {
                ...
                {
                    $sql = "SELECT dk.Nama_Lengkap AS Last_User FROM data_karyawan dk
                                WHERE dk.KaryawanNID = '".$Last_User."'
                                ";
                    //echo $sql.";<br>";
                    $qry = mysqli_query($Connection, $sql);
                    $buff = mysqli_fetch_array($qry);
    ...
    elseif(isset($_POST['Action']))
    {
        if($_POST['Action']=='Dokumen_Siswa_Update' || $_POST['Action']=='Dokumen_Siswa_Tambah')
        {
            ...
            ?>
                <script>
                    window.location.href="kpi_ho.php?Action=Daftar";
                </script>
            <?php
        }

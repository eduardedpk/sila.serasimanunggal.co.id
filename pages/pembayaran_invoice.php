...
else 
{
    ...
    if(isset($_GET['Action']))
    {
                ...
                <body class="fixed-left">
                            ...
                            <div class="content">
                                ...
                                <div class="">
                                    <div class="page-header-title">
                                        <h4 class="page-title">Pembayaran Invoice </h4>
                                    </div>
                                </div>
                                <?php
                                    ...
                                    <div class="container">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9 input-group date" >
                                                                ...
                                                                <select name="Waktu" id="inputWaktu" onchange="CekWaktu()" class="form-control">
                                                                    ...
                                                                    <option value="<?php echo $Waktu_Sebelumnya?>" <?php echo ($Waktu_Sebelumnya==$Periode_Laporan)?"selected":"" ?>><?php echo $Text_Item_Sebelumnya ?></option>
                                                                    <?php
                                                                    ...
                                                                    else
                                                                    {
                                                                        while ($buff = mysqli_fetch_array($qry)) 
                                                                        {
                                                                            ...
                                                                            {
                                                                                ?>
                                                                                <option value="<?php echo $Waktu?>" <?php echo ($Waktu==$Periode_Laporan)?"selected":"" ?>><?php echo $Current_Text_Item ?></option>
                                                                                <?php
                                                                            }
                                        ...
                                        <div class="panel">
                                            <div class="panel-body table-responsive">
                                                ...
                                                {
                                                    ?>
                                                    <p><a href="pembayaran_invoice.php?Action=Dokumen_Tambah" class="btn btn-info" title="Klik untuk menambah data"><i class="fa fa-plus"></i> Data</a></p>
                                                    <?php
                                                }
                                                else
                                                {
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if($Hak_Akses==2)
                                                        {
                                                            $sql = "SELECT lh.*, c.Nama_Cabang FROM laporan_harian lh 
                                                                        ...
                                                                        WHERE lh.Jenis_LaporanNID = 6 AND lh.Periode = '".$Tahun_Tanggal."-".$Bulan_Tanggal."'
                                                        ...
                                                        while($buff_Data_Siswa = mysqli_fetch_array($qry_Data_Siswa))
                                                        {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align:left">
                                                                    <a href="pembayaran_invoice.php?Action=Dokumen_Update&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>"><i class="ti-pencil" title="Update data"></i></a>
                                                                    <a href="pembayaran_invoice.php?Action=Dokumen_Hapus&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>" style="color:red;padding-left:10px" title="Hapus data"><i class="ti-trash"></i></a>
                                                                </td>
                                                            </tr>
                                                            <?php
                                                            $Nomor_Urut++;
                    ...
                    <script>
                        function CekWaktu() 
                        {
                            ...
                            window.location.href="pembayaran_invoice.php?Action=Daftar&Periode="+Periode;
                        }
                        function CekCabang() 
                        {
                            var Cabang = document.getElementById("inputCabang").value;
                            
                            window.location.href="pembayaran_invoice.php?Action=Daftar&Cabang="+Cabang;
                        }
                ...
                <body class="fixed-left">
                                ...
                                <div id="sidebar-menu">
                                    ...
                                    if($Hak_Akses==1) //Administrator
                                    {
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="pembayaran_invoice.php?Action=Daftar" class="waves-effect"><i class="ti-back-left"></i><span> Kembali </span></a>
                                            </li>
                                        </ul>
                                        <?php
                                    }
                                    ...
                                    <div class="container">
                                        <div class="panel">
                                            <div class="panel-body table-responsive">
                                                ...
                                                {
                                                    ?>
                                                    <p><a href="pembayaran_invoice.php?Action=Dokumen_Detail_Tambah&Tanggal=<?php echo $Tanggal_Laporan ?>" class="btn btn-info" title="Klik untuk menambah data"><i class="fa fa-plus"></i> Data</a></p>
                                                    <?php
                                                }
                                                else
                                                {
                                                            ...
                                                            <tr>
                                                                ...
                                                                if($Hak_Akses==2)
                                                                {
                                                                    ...
                                                                    <td style="text-align:center">
                                                                        <a href="pembayaran_invoice.php?Action=Dokumen_Valid&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>"><i class="fa <?php echo ($IsValid==1)?"fa-check":"fa-times" ?>"></i></a>
                                                                    </td>
                                                                    <?php
                                                                }
                                                                else
                                                                {
                                                                    ?>
                                                                    <td style="text-align:center">
                                                                        <a href="pembayaran_invoice.php?Action=Dokumen_Detail_Update&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>"><i class="fa fa-pencil"></i></a>
                                                                        <a href="pembayaran_invoice.php?Action=Dokumen_Detail_Hapus&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>" title="Hapus laporan"><i class="fa fa-trash"></i></a>
                                                                    </td>
                                                                    <?php
                                                                }
                    ...
                    <script>
                        function CekWaktu() 
                        {
                            ...
                            window.location.href="pembayaran_invoice.php?Action=Daftar&Tanggal="+Tanggal;
                        }
        ...
        elseif($_GET['Action']=='Dokumen_Detail_Hapus')
        {
            ...
            $_SESSION['Parrent_Page'] = 'pembayaran_invoice.php?Action=Daftar';
            ?>
            <!DOCTYPE html>
            <html>
                <head>
                            ...
                            <div class="sidebar-inner slimscrollleft">
                                ...
                                <div id="sidebar-menu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="pembayaran_invoice.php?Action=Detail_Laporan&Tanggal=<?php echo $Tanggal_Laporan ?>" class="waves-effect"><i class="ti-back-left"></i><span> Kembali </span></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="clearfix"></div>
                                    ...
                                    <div class="container">
                                        <div class="panel">
                                            <div class="panel-body">
                                                <form class="form-horizontal" name="form_tambah" action="pembayaran_invoice.php" method="post" enctype="multipart/form-data">
        ...
        if($_POST['Action']=='Dokumen_Siswa_Update' || $_POST['Action']=='Dokumen_Siswa_Tambah')
        {
            if(isset($_POST['submit']))
            {
                ...
                elseif($_POST['Action']=='Dokumen_Siswa_Tambah')
                {
                    ...
                    $Image_Before = "";
                    $Image_After = "";
                    $sql = "INSERT INTO laporan_harian(CabangNID, Jenis_LaporanNID, Periode, Tanggal, Creator, Create_Date, Last_User) VALUES 
                                ('$CabangNID', '$Jenis_LaporanNID', '$Periode', '$Tanggal', '$Last_UserNID', now(), '$Last_UserNID') ";
                    //echo $sql.";<br>";
                    $qry = mysqli_query($Connection, $sql);
            ...
            ?>
                <script>
                    window.location.href="pembayaran_invoice.php?Action=Daftar";
                </script>
            <?php
        }

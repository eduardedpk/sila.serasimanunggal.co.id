...
else 
{
    ...
    if(isset($_GET['Action']))
    {
                ...
                <body class="fixed-left">
                            ...
                            <div class="content">
                                ...
                                <div class="">
                                    <div class="page-header-title">
                                        <h4 class="page-title">Check List Toilet </h4>
                                    </div>
                                </div>
                                <?php
                                    ...
                                    <div class="container">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9 input-group date" >
                                                                ...
                                                                if($Hak_Akses==2)
                                                                {
                                                                    $sql = "SELECT * FROM laporan_harian lh 
                                                                                INNER JOIN laporan_jenis lj ON lj.Jenis_LaporanNID = lh.Jenis_LaporanNID
                                                                                WHERE lh.CabangNID = '".$Filter_Cabang."' AND lj.Jenis_Laporan = 'Check List Toilet'  
                                                                                GROUP BY year(lh.Tanggal), month(lh.Tanggal);";
                                                                }
                                                                else
                                                                {
                                                                    $sql = "SELECT * FROM laporan_harian lh 
                                                                                INNER JOIN laporan_jenis lj ON lj.Jenis_LaporanNID = lh.Jenis_LaporanNID
                                                                                WHERE lh.CabangNID = '".$CabangNID."' AND lj.Jenis_Laporan = 'Check List Toilet'   
                                                                                GROUP BY year(lh.Tanggal), month(lh.Tanggal);";
                                                                }
                                        ...
                                        <div class="panel">
                                            <div class="panel-body table-responsive">
                                                ...
                                                {
                                                    ?>
                                                    <p><a href="check_list_toilet.php?Action=Dokumen_Tambah" class="btn btn-info" title="Klik untuk menambah data"><i class="fa fa-plus"></i> Data</a></p>
                                                    <?php
                                                }
                                                else
                                                {
                                                ...
                                                <table id="data-kehadiran" class="display" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width=45% colspan=1 style="text-align:left;vertical-align:middle">Jumlah Dokumen</th>
                                                        </tr>
                                                    </thead>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if($Hak_Akses==2)
                                                        {
                                                            $sql = "SELECT lh.*, count(lh.Tanggal) AS Jumlah_Gambar FROM laporan_harian lh
                                                                        WHERE lh.Jenis_LaporanNID = 2 AND
                                                                                year(lh.Tanggal) = '".$Tahun_Tanggal."'  AND month(lh.Tanggal) = '".$Bulan_Tanggal."' AND lh.CabangNID = '".$Filter_Cabang."' AND lh.Cuti = 0
                                                                        GROUP BY lh.Tanggal
                                                        ...
                                                        else
                                                        {
                                                            $sql = "SELECT lh.*, count(lh.Tanggal) AS Jumlah_Gambar FROM laporan_harian lh
                                                                        WHERE lh.Jenis_LaporanNID = 2 AND
                                                                                year(lh.Tanggal) = '".$Tahun_Tanggal."'  AND month(lh.Tanggal) = '".$Bulan_Tanggal."' AND lh.CabangNID = '".$CabangNID."' AND lh.Cuti = 0
                                                                        GROUP BY lh.Tanggal
                                                                        ORDER BY lh.Tanggal ASC;";
                                                        }
                                                        ...
                                                        while($buff_Data_Siswa = mysqli_fetch_array($qry_Data_Siswa))
                                                        {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align:left"><a href="check_list_toilet.php?Action=Detail_Laporan&Tanggal=<?php echo $Tanggal_Report ?>"><?php echo $Daftar_Hari[$Hari].", ".date("d-m-Y", $Tanggal_Report_Tampilan) ?></a></td>
                    ...
                    <script>
                        function CekWaktu() 
                        {
                            ...
                            window.location.href="check_list_toilet.php?Action=Daftar&Tanggal="+Tanggal;
                        }
                        function CekCabang() 
                        {
                            var Cabang = document.getElementById("inputCabang").value;
                            
                            window.location.href="check_list_toilet.php?Action=Daftar&Cabang="+Cabang;
                        }
                                ...
                                <div id="sidebar-menu">
                                    ...
                                    if($Hak_Akses==1) //Administrator
                                    {
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="check_list_toilet.php?Action=Daftar" class="waves-effect"><i class="ti-back-left"></i><span> Kembali </span></a>
                                            </li>
                                        </ul>
                                        <?php
                                    }
                                    ...
                                    <div class="container">
                                        <div class="panel">
                                            <div class="panel-body table-responsive">
                                                ...
                                                {
                                                    ?>
                                                    <p><a href="check_list_toilet.php?Action=Dokumen_Detail_Tambah&Tanggal=<?php echo $Tanggal_Laporan ?>" class="btn btn-info" title="Klik untuk menambah data"><i class="fa fa-plus"></i> Data</a></p>
                                                    <?php
                                                }
                                                else
                                                {
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if($Hak_Akses==2)
                                                        {
                                                            ...
                                                            $sql = "SELECT lh.* FROM laporan_harian lh
                                                                        WHERE lh.Jenis_LaporanNID = 2 AND lh.CabangNID = ".$Filter_Cabang."
                                                            ...
                                                            <tr>
                                                                ...
                                                                if($Hak_Akses==2)
                                                                {
                                                                    ...
                                                                    <td style="text-align:center">
                                                                        <a href="check_list_toilet.php?Action=Dokumen_Valid&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>"><i class="fa <?php echo ($IsValid==1)?"fa-check":"fa-times" ?>"></i></a>
                                                                    </td>
                                                                    <?php
                                                                }
                                                                else
                                                                {
                                                                    ?>
                                                                    <td style="text-align:center">
                                                                        <a href="check_list_toilet.php?Action=Dokumen_Detail_Update&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>"><i class="fa fa-pencil"></i></a>
                                                                        <a href="check_list_toilet.php?Action=Dokumen_Detail_Hapus&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>" title="Hapus laporan"><i class="fa fa-trash"></i></a>
                                                                    </td>
                                                                    <?php
                                                                }
        ...
        elseif($_GET['Action']=='Dokumen_Detail_Hapus')
        {
            ...
            $_SESSION['Parrent_Page'] = 'check_list_toilet.php?Action=Daftar';
            ?>
            <!DOCTYPE html>
            <html>
                <head>
                            ...
                            <div class="sidebar-inner slimscrollleft">
                                ...
                                <div id="sidebar-menu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="check_list_toilet.php?Action=Detail_Laporan&Tanggal=<?php echo $Tanggal_Laporan ?>" class="waves-effect"><i class="ti-back-left"></i><span> Kembali </span></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="clearfix"></div>
                                    ...
                                    <div class="container">
                                        <div class="panel">
                                            <div class="panel-body">
                                                <form class="form-horizontal" name="form_tambah" action="check_list_toilet.php" method="post" enctype="multipart/form-data">
                    ...
                    <div id="wrapper">
                        ...
                        <div class="content-page">
                            ...
                            <div class="content">
                                ...
                                <div class="">
                                    <div class="page-header-title">
                                        <h4 class="page-title"><?php echo (($_GET['Action']=='Dokumen_Update')?"Update":"Tambah") ?> Dokumen FIA </h4>
                                    </div>
                                </div>
        ...
        if($_POST['Action']=='Dokumen_Siswa_Update' || $_POST['Action']=='Dokumen_Siswa_Tambah')
        {
            if(isset($_POST['submit']))
            {
                ...
                if(date("Y-m-d H:i:s") < $Batas_Waktu)
                {
                    ...
                    $Jenis_LaporanNID = 2; //Check List Toilet
                    ...
                    if($_POST['Action']=='Dokumen_Siswa_Update')
                    {
                        ...
                        if($_FILES['inputFileBefore']['name']<>"")
                        {
                            ...
                            if(strtolower($Ekstensi_File)=='jpg' || strtolower($Ekstensi_File)=='jpeg' || strtolower($Ekstensi_File)=='png' || strtolower($Ekstensi_File)=='pdf')
                            {
                    ...
                    elseif($_POST['Action']=='Dokumen_Siswa_Tambah')
                    {
                        ...
                        if($_FILES['inputFileBefore']['name']<>"")
                        {
                            ...
                            $uploadfile = fopen($_FILES['inputFileBefore']['tmp_name'],"r");//打开文件
                            $filesize = $_FILES['inputFileBefore']['size'];//文件大小
                            $buffer = fread($uploadfile, $filesize);//读文件内容
                            $ori_file_name = $_FILES['inputFileBefore']['name'];//原始文件名

                            $ch = curl_init();
                            // set url
                            curl_setopt($ch, CURLOPT_URL, 'https://storage.sgp.cloud.ovh.net/v1/AUTH_b450f64b5c0c4c2c9ef8748b25d885d9/test_gambar/'.$ori_file_name);
                            curl_setopt($ch, CURLOPT_HEADER, true);
                            //set to true to return the transfer as a string
                            curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
                            curl_setopt($ch, CURLOPT_HTTPHEADER, array('X-Auth-Token: b450f64b5c0c4c2c9ef8748b25d885d9', "X-Object-Meta-Orig-Filename: ".preg_replace("/[ ,\n,\t,\r]/", '', $ori_file_name)));
                    ...
                    ?>
                        <script>
                            //window.location.href="check_list_toilet.php?Action=Daftar";
                        </script>
                    <?php
                }
                else
                {
                    ?>
                        <script>
                            window.location.href="check_list_toilet.php?Action=Dokumen_Tambah&Alert=true";
                        </script>
                    <?php
                }
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(date("Y-m-d H:i:s") < $Batas_Waktu)
                {
                    ...
                    if($_POST['Action']=='Dokumen_Detail_Update')
                    {
                        ...
                        if($Simpan_File_Berhasil==1 || ($_FILES['inputFileBefore']['name']==""))
                        {
                    ...
                    ?>
                        <script>
                            window.location.href="check_list_toilet.php?Action=Detail_Laporan&Tanggal=<?php echo $Tanggal ?>";
                        </script>
                    <?php
                }
                else
                {
                    if($_POST['Action']=='Dokumen_Detail_Update')
                    {
                        ...
                        ?>
                            <script>
                                window.location.href="check_list_toilet.php?Action=Dokumen_Detail_Update&Tanggal=<?php echo $Tanggal ?>&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>&Alert=true";
                            </script>
                        <?php
                    }
                    else
                    {
                        ?>
                            <script>
                                window.location.href="check_list_toilet.php?Action=Dokumen_Detail_Tambah&Tanggal=<?php echo $Tanggal ?>&Alert=true";
                            </script>
                        <?php
                    }

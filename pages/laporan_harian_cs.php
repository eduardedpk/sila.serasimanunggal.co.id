...
else 
{
    ...
    if(isset($_GET['Action']))
    {
                ...
                <body class="fixed-left">
                        ...
                        <div class="content-page">
                            ...
                            <div class="content">
                                ...
                                if(isset($_GET['Tanggal']))
                                {
                                    ...
                                    $_SESSION['Tanggal_Laporan_CS'] = $Tanggal_Laporan;
                                }
                                else
                                {   
                                    if(!isset($_SESSION['Tanggal_Laporan_CS']))
                                    {
                                        $_SESSION['Tanggal_Laporan_CS'] = date('d-m-Y');
                                        $Tanggal_Laporan = $_SESSION['Tanggal_Laporan_CS'];
                                    }
                                    else
                                    {
                                        $Tanggal_Laporan = $_SESSION['Tanggal_Laporan_CS'];
                                ...
                                $Tanggal_Filter = substr($Tanggal_Laporan,-4)."-".substr($Tanggal_Laporan, 3, 2)."-".substr($Tanggal_Laporan,0,2);
                                ...
                                <div class="page-content-wrapper ">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group">
                                                    <label for="inputKelas" class="col-sm-3 ">Tanggal</label>
                                                    
                                                    <div class="col-sm-9 input-group date" >
                                                        <div class="input-group">
                                                            <input type="text" class="form-control"  placeholder="dd/mm/yyyy" id="Tanggal_Laporan" name="Tanggal_Laporan" value="<?php echo $Tanggal_Laporan ?>">
                                                        </div><!-- input-group -->
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <table id="data-kehadiran" class="display" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width=20% rowspan=1 style="text-align:left;vertical-align:middle">Hari, Tanggal</th>
                                                            <th width=35% colspan=1 style="text-align:left;vertical-align:middle">Branch</th>
                                                            <th width=35% colspan=1 style="text-align:left;vertical-align:middle">Jenis Laporan</th>
                                                        </tr>
                                                    </thead>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sql = "SELECT lh.Laporan_HarianNID, lh.Tanggal, c.Nama_Cabang, lj.Jenis_Laporan FROM laporan_harian lh
                                                                    INNER JOIN cabang c ON c.CabangNID = lh.CabangNID
                                                                    INNER JOIN laporan_jenis lj ON lj.Jenis_LaporanNID = lh.Jenis_LaporanNID
                                                                    WHERE lh.IsValid = 0 AND lh.Jenis_LaporanNID NOT IN (6,7) AND lh.CabangNID = '".$Filter_Cabang."'
                                                                    AND lh.Tanggal = '".$Tanggal_Filter."'
                                                                    ORDER BY lh.Tanggal, lh.CabangNID;";
                                                        $sql = "SELECT lh.Laporan_HarianNID, lh.Tanggal, c.Nama_Cabang, lj.Jenis_Laporan FROM laporan_harian lh
                                                                    INNER JOIN cabang c ON c.CabangNID = lh.CabangNID
                                                                    INNER JOIN laporan_jenis lj ON lj.Jenis_LaporanNID = lh.Jenis_LaporanNID
                                                                    WHERE lh.IsValid = 0 AND lh.Jenis_LaporanNID NOT IN (6,7)
                                                                    AND lh.Tanggal = '".$Tanggal_Filter."'
                                                                    GROUP BY lh.CabangNID, lh.Jenis_LaporanNID
                                                                    ORDER BY lh.Tanggal, lh.CabangNID;";
                                                        //echo $sql.";<br>";
                                                        ...
                                                        while($buff_Data_Siswa = mysqli_fetch_array($qry_Data_Siswa))
                                                        {
                                                            ...
                                                            $Jenis_Laporan = $buff_Data_Siswa['Jenis_Laporan'];
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align:left"><a href="laporan_harian_cs.php?Action=Detail_Laporan&Tanggal=<?php echo $Tanggal_Report ?>&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>"><?php echo $Daftar_Hari[$Hari].", ".date("d-m-Y", $Tanggal_Report_Tampilan) ?></a></td>
                                                                <td style="text-align:left"><?php echo $Nama_Cabang ?></td>
                                                                <td style="text-align:left"><?php echo $Jenis_Laporan ?></td>
                                                            </tr>
                                                            <?php
                                                            $Nomor_Urut++;
                                                        }
                    ...
                    <script>
                        function CekWaktu() 
                        {
                            ...
                            window.location.href="laporan_harian_cs.php?Action=Daftar&Tanggal="+Tanggal;
                        }
                        function CekCabang() 
                        {
                            var Cabang = document.getElementById("inputCabang").value;
                            
                            window.location.href="laporan_harian_cs.php?Action=Daftar&Cabang="+Cabang;
                        }
                    ...
                    <script type="text/javascript">
                        ...
                        $( "#Tanggal_Laporan" ).datepicker(
                            ...
                            $('#Tanggal_Laporan').change();
                        });
                        $('#Tanggal_Laporan').change(function () {
                            var Tanggal = document.getElementById("Tanggal_Laporan").value;
                            //alert(Tanggal);
                            window.location.href="laporan_harian_cs.php?Action=Daftar&Tanggal="+Tanggal;
                        });
                ...
                <body class="fixed-left">
                    ...
                    <div id="wrapper">
                                ...
                                <div id="sidebar-menu">
                                    ...
                                    if($Hak_Akses==1) //Administrator
                                    {
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="laporan_harian_cs.php?Action=Daftar" class="waves-effect"><i class="ti-back-left"></i><span> Kembali </span></a>
                                            </li>
                                        </ul>
                                        <?php
                                    }
                        ...
                        <div class="content-page">
                            ...
                            <div class="content">
                                <?php
                                //Ambil jenis laporan dan tanggal
                                $sql = "SELECT lh.Jenis_LaporanNID, lh.Tanggal, lh.CabangNID, lh.Periode FROM laporan_harian lh
                                            WHERE Laporan_HarianNID = '".$Laporan_HarianNID."' ";
                                //echo $sql.";<br>";
                                $qry_Data_Siswa = mysqli_query($Connection, $sql);
                                $buff_Data_Siswa = mysqli_fetch_array($qry_Data_Siswa);
                                $Jenis_Laporan = $buff_Data_Siswa['Jenis_LaporanNID'];
                                $Tanggal = $buff_Data_Siswa['Tanggal'];
                                $Cabang_Laporan = $buff_Data_Siswa['CabangNID'];
                                $Periode_Laporan = $buff_Data_Siswa['Periode'];
                                if($Jenis_Laporan==1)
                                {
                                                    ...
                                                    <table id="data-kehadiran" class="display" style="width:100%">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $sql = "SELECT lh.* FROM laporan_harian lh
                                                                        WHERE lh.CabangNID = '".$Cabang_Laporan."' AND lh.Tanggal = '".$Tanggal."' 
                                                                        AND lh.Jenis_LaporanNID = 1 ";
                                                            //echo $sql.";<br>";
                                                            $qry_Data_Siswa = mysqli_query($Connection, $sql);
                                                            while($buff_Data_Siswa = mysqli_fetch_array($qry_Data_Siswa))
                                                            {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    if($Hak_Akses==2)
                                                                    {
                                                                        ...
                                                                        <td style="text-align:center">
                                                                            <a href="laporan_harian_cs.php?Action=Dokumen_Valid&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>"><i class="fa <?php echo ($IsValid==1)?"fa-check":"fa-times" ?>"></i></a>
                                                                        </td>
                                                                        <?php
                                                                    }
                                                                    else
                                                                    {
                                                                        ?>
                                                                        <td style="text-align:center">
                                                                            <a href="laporan_harian_cs.php?Action=Dokumen_Detail_Update&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>"><i class="fa fa-pencil"></i></a>
                                                                        </td>
                                                                        <?php
                                                                    }
                                ...
                                elseif($Jenis_Laporan==3)
                                {
                                    ...
                                    <div class="">
                                        <div class="page-header-title">
                                            <h4 class="page-title">Inspeksi Area <?php echo $Daftar_Hari[$Hari].", ".date("d-m-Y", $Tanggal_Report_Tampilan) ?></h4>
                                        </div>
                                    </div>
                                        ...
                                        <div class="container">
                                            <div class="panel">
                                                <div class="panel-body table-responsive">
                                                    ...
                                                    {
                                                        ?>
                                                        <p><a href="laporan_harian_cs.php?Action=Dokumen_Detail_Tambah&Tanggal=<?php echo $Tanggal_Laporan ?>" class="btn btn-info" title="Klik untuk menambah data"><i class="fa fa-plus"></i> Data</a></p>
                                                        <?php
                                                    }
                                                    else
                                                    {
                                                    ...
                                                    <table id="data-kehadiran" class="display" style="width:100%">
                                                        <thead>
                                                            <tr>
                                                                <th width=5% rowspan=1 style="text-align:center;vertical-align:middle">No</th>
                                                                <th width=60% colspan=1 style="text-align:left;vertical-align:middle">Dokumen</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if($Hak_Akses==2)
                                                            {
                                                                ...
                                                                $sql = "SELECT lh.* FROM laporan_harian lh
                                                                        WHERE lh.CabangNID = '".$Cabang_Laporan."' AND lh.Tanggal = '".$Tanggal."' 
                                                                        AND lh.Jenis_LaporanNID = 3 ";
                                                            }
                                                            else
                                                            {
                                                                $sql = "SELECT lh.* FROM laporan_harian lh
                                                                            WHERE lh.Jenis_LaporanNID = 3 AND lh.CabangNID = ".$CabangNID."
                                                            ...
                                                            while($buff_Data_Siswa = mysqli_fetch_array($qry_Data_Siswa))
                                                            {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <!--<td style="text-align:center"><a href="" judul="" data-toggle="modal" src="<?php echo $Before ?>" data-target=".new-project-modal" class="popup">View</a> </td>-->
                                                                    <?php
                                                                    if($Hak_Akses==2)
                                                                    {
                                                                        ?>
                                            ...
                                            <div class="modal fade show-image-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="">
                                                        ...
                                                        <iframe class="" src="" style="max-width: 100%;height: 400px;" id="popup-img" width='100%' height='100%'></iframe>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                elseif($Jenis_Laporan==2)
                                {
                                    ...
                                    <div class="">
                                        <div class="page-header-title">
                                            <h4 class="page-title">Check List Toilet <?php echo $Daftar_Hari[$Hari].", ".date("d-m-Y", $Tanggal_Report_Tampilan) ?></h4>
                                        </div>
                                    </div>
                                                    ...
                                                    <table id="data-kehadiran" class="display" style="width:100%">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if($Hak_Akses==2)
                                                            {
                                                                ...
                                                                $sql = "SELECT lh.* FROM laporan_harian lh
                                                                        WHERE lh.CabangNID = '".$Cabang_Laporan."' AND lh.Tanggal = '".$Tanggal."' 
                                                                        AND lh.Jenis_LaporanNID = 2 ";
                                                            }
                                                            else
                                                            {
                                                                $sql = "SELECT lh.* FROM laporan_harian lh
                                                                            WHERE lh.Jenis_LaporanNID = 2 AND lh.CabangNID = ".$CabangNID."
                                                                                    AND year(lh.Tanggal) = '".$Tahun_Tanggal."'  AND month(lh.Tanggal) = '".$Bulan_Tanggal."' AND lh.Tanggal = '".$Tanggal_Laporan."'
                                                                            ";
                                                            }
                                                            //echo $sql.";<br>";
                                ...
                                elseif($Jenis_Laporan==5)
                                {
                                    ...
                                    <div class="">
                                        <div class="page-header-title">
                                            <h4 class="page-title">Pengguna Jasa <?php echo $Daftar_Hari[$Hari].", ".date("d-m-Y", $Tanggal_Report_Tampilan) ?></h4>
                                        </div>
                                    </div>
                                                    ...
                                                    <table id="data-kehadiran" class="display" style="width:100%">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if($Hak_Akses==2)
                                                            {
                                                                $Filter_Cabang = $_SESSION['Filter_Cabang'];
                                                                $sql = "SELECT lh.* FROM laporan_harian lh
                                                                            WHERE lh.Laporan_HarianNID = ".$Laporan_HarianNID."
                                                                            ";
                                                            }
                                                            else
                                                            {
        ...
        elseif($_GET['Action']=='Dokumen_Update' || $_GET['Action']=='Dokumen_Tambah')
        {
            ...
            $_SESSION['Parrent_Page'] = 'laporan_harian_cs.php?Action=Daftar';
            ?>
            <!DOCTYPE html>
            <html>
                <head>
                                    ...
                                    <div class="container">
                                        <div class="panel">
                                            <div class="panel-body">
                                                ...
                                                <form class="form-horizontal" name="form_tambah" action="laporan_harian_cs.php" method="post" enctype="multipart/form-data">
                                                    <?php 
                            ...
                            <div class="sidebar-inner slimscrollleft">
                                ...
                                <div id="sidebar-menu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="laporan_harian_cs.php?Action=Detail_Laporan&Tanggal=<?php echo $Tanggal_Laporan ?>" class="waves-effect"><i class="ti-back-left"></i><span> Kembali </span></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="clearfix"></div>
    ...
    elseif(isset($_POST['Action']))
    {
        if($_POST['Action']=='Dokumen_Siswa_Update' || $_POST['Action']=='Dokumen_Siswa_Tambah')
        {
            if(isset($_POST['submit']))
            {
                ...
                $Tanggal_Besok = date('Y-m-d', strtotime($Tanggal_Hari_Ini .' +8 day'));
                ...
                if(date("Y-m-d H:i:s") < $Batas_Waktu)
                {
                    ...
                    ?>
                        <script>
                            window.location.href="laporan_harian_cs.php?Action=Daftar";
                        </script>
                    <?php
                }
                else
                {
                    ?>
                        <script>
                            window.location.href="laporan_harian_cs.php?Action=Dokumen_Tambah&Alert=true";
                        </script>
                    <?php
                }
        ...
        if($_POST['Action']=='Dokumen_Detail_Update' || $_POST['Action']=='Dokumen_Detail_Tambah')
        {
            if(isset($_POST['submit']))
            {
                ...
                if(date("Y-m-d H:i:s") < $Batas_Waktu)
                {
                    ...
                    ?>
                        <script>
                            window.location.href="laporan_harian_cs.php?Action=Detail_Laporan&Tanggal=<?php echo $Tanggal ?>";
                        </script>
                    <?php
                }
                else
                {
                    ?>
                        <script>
                            window.location.href="laporan_harian_cs.php?Action=Dokumen_Detail_Tambah&Tanggal=<?php echo $Tanggal ?>&Alert=true";
                        </script>
                    <?php
                }

...
else 
{
    ...
    if(isset($_GET['Action']))
    {
                ...
                <body class="fixed-left">
                                    ...
                                    <div class="container">
                                            ...
                                            <div id="demo" class="collapse">
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9 input-group date" >
                                                                ...
                                                                $sql = "SELECT * FROM laporan_harian lh 
                                                                            ...
                                                                            WHERE lh.CabangNID = '".$CabangNID."' AND lj.Jenis_Laporan = 'Laporan Harian HO'
                                                    ...
                                                    if($Hak_Akses==2)
                                                    {
                                                        ...
                                                        <div class="col-sm-6 col-lg-6">
                                                            <div class="form-group">
                                                                <label for="inputUser" class="col-sm-3 ">User</label>
                                                                ...
                                                                <div class="col-sm-9 input-group date" >
                                                                    ...
                                                                    $sql = "SELECT * FROM data_karyawan dk
                                                                                ...
                                                                                WHERE dk.Aktif = 1 AND dk.IsLeader = 0 AND dk.NIM <> 'Direksi'
                                                                                AND dk.CabangNID = 34;
                                                                                ";
                                                                    //echo $sql.";<br>";
                                                                    //echo "Cabang : ".$Filter_Cabang."<br>";
                                                                    ...
                                                                    //echo "Filter tanggal ".$Filter_Tanggal."<br>";
                                                                    ?>
                                                                    <select name="UserNID" id="inputUser" onchange="CekUser()" class="form-control">
                                                                        <?php
                                                                        while ($buff = mysqli_fetch_array($qry)) 
                                                                        {
                                                                            $Current_NIK = $buff['NIM'];
                                                                            $Current_UserNID = $buff['UserNID'];
                                                                            $Nama_Lengkap = $buff['Nama_Lengkap'];
                                                                            ?>
                                                                            <option value="<?php echo $Current_UserNID?>" <?php echo ($Filter_UserNID==$Current_UserNID)?"selected":"" ?> ><?php echo $Nama_Lengkap ?></option>
                                                                            <?php
                                                                        }
                                        ...
                                        <div class="panel">
                                            <div class="panel-body table-responsive">
                                                <?php 
                                                if($Hak_Akses==4 || $Hak_Akses==5)
                                                {
                                                    ?>
                                                    <p><a href="laporan_harian_nonCS.php?Action=Dokumen_Tambah" class="btn btn-info" title="Klik untuk menambah data"><i class="fa fa-plus"></i> Data</a></p>
                                                    <?php
                                                }
                                                else
                                                {
                                                ...
                                                <table id="data-kehadiran" class="display" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width=45% colspan=1 style="text-align:left;vertical-align:middle">Jumlah Laporan</th>
                                                        </tr>
                                                    </thead>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if($Hak_Akses==2)
                                                        {
                                                            $sql = "SELECT lh.*, count(lh.Tanggal) AS Jumlah_Gambar FROM laporan_harian lh
                                                                        WHERE lh.Jenis_LaporanNID = 7 AND
                                                                                year(lh.Tanggal) = '".$Tahun_Tanggal."'  AND month(lh.Tanggal) = '".$Bulan_Tanggal."' AND lh.Last_User = '".$Filter_UserNID."'
                                                                        GROUP BY lh.Tanggal
                                                        ...
                                                        else
                                                        {
                                                            $sql = "SELECT lh.*, count(lh.Tanggal) AS Jumlah_Gambar FROM laporan_harian lh
                                                                        WHERE lh.Jenis_LaporanNID = 7 AND
                                                                                year(lh.Tanggal) = '".$Tahun_Tanggal."'  AND month(lh.Tanggal) = '".$Bulan_Tanggal."' AND lh.Last_User = '".$Last_UserNID."'
                                                                        GROUP BY lh.Tanggal
                                                                        ORDER BY lh.Tanggal ASC;";
                                                        }
                                                        //echo $sql.";<br>";
                                                        ...
                                                        while($buff_Data_Siswa = mysqli_fetch_array($qry_Data_Siswa))
                                                        {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align:left"><a href="laporan_harian_nonCS.php?Action=Detail_Laporan&Tanggal=<?php echo $Tanggal_Report ?>"><?php echo $Daftar_Hari[$Hari].", ".date("d-m-Y", $Tanggal_Report_Tampilan) ?></a></td>
                    ...
                    <script>
                        function CekWaktu() 
                        {
                            ...
                            window.location.href="laporan_harian_nonCS.php?Action=Daftar&Tanggal="+Tanggal;
                        }
                        function CekUser() 
                        {
                            var UserNID = document.getElementById("inputUser").value;
                            
                            window.location.href="laporan_harian_nonCS.php?Action=Daftar&UserNID="+UserNID;
                        }
                                ...
                                <div id="sidebar-menu">
                                    ...
                                    if($Hak_Akses==1) //Administrator
                                    {
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="laporan_harian_nonCS.php?Action=Daftar" class="waves-effect"><i class="ti-back-left"></i><span> Kembali </span></a>
                                            </li>
                                        </ul>
                                        <?php
                                    }
                                    ...
                                    <div class="container">
                                        <div class="panel">
                                            <div class="panel-body table-responsive">
                                                ...
                                                {
                                                    ?>
                                                    <p><a href="laporan_harian_nonCS.php?Action=Dokumen_Detail_Tambah&Tanggal=<?php echo $Tanggal_Laporan ?>" class="btn btn-info" title="Klik untuk menambah data"><i class="fa fa-plus"></i> Data</a></p>
                                                    <?php
                                                }
                                                else
                                                {
                                                ...
                                                <table id="data-kehadiran" class="display" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width=55% rowspan=1 style="text-align:left;vertical-align:middle">Keterangan</th>
                                                            <th width=25% colspan=1 style="text-align:center;vertical-align:middle">File</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if($Hak_Akses==2)
                                                        {
                                                            ...
                                                            $sql = "SELECT lh.* FROM laporan_harian lh
                                                                        WHERE lh.Jenis_LaporanNID = 7 AND lh.Last_User = ".$Filter_UserNID."
                                                        ...
                                                        {
                                                            $sql = "SELECT lh.* FROM laporan_harian lh
                                                                        WHERE lh.Jenis_LaporanNID = 7 AND lh.Last_User = ".$Last_UserNID."
                                                                                AND year(lh.Tanggal) = '".$Tahun_Tanggal."'  AND month(lh.Tanggal) = '".$Bulan_Tanggal."' AND lh.Tanggal = '".$Tanggal_Laporan."'
                                                                        ";
                                                        }
                                                        ...
                                                        while($buff_Data_Siswa = mysqli_fetch_array($qry_Data_Siswa))
                                                        {
                                                            ...
                                                            <tr>
                                                                ...
                                                                if($Hak_Akses==2)
                                                                {
                                                                    ...
                                                                    <td style="text-align:center"><a href="<?php echo $Before ?>" judul="" ><i class="fa fa-eye"></i></a> </td>
                                                                    <td style="text-align:center">
                                                                        <a href="laporan_harian_nonCS.php?Action=Dokumen_Valid&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>"><i class="fa  <?php echo ($IsValid==1)?"fa-check":"fa-times" ?>"></i></a>
                                                                    </td>
                                                                    <?php
                                                                }
                                                                else
                                                                {
                                                                    ...
                                                                    <td style="text-align:center"><a href="<?php echo $Before ?>" judul="" ><i class="fa fa-eye"></i></a> </td>
                                                                    <td style="text-align:center">
                                                                        <a href="laporan_harian_nonCS.php?Action=Dokumen_Detail_Update&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>"><i class="fa fa-pencil"></i></a>
                                                                        <a href="laporan_harian_nonCS.php?Action=Dokumen_Detail_Hapus&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>" title="Hapus laporan"><i class="fa fa-trash"></i></a>
                                                                    </td>
                                                                    <?php
                                                                }
        ...
        elseif($_GET['Action']=='Dokumen_Detail_Hapus')
        {
            ...
            $_SESSION['Parrent_Page'] = 'laporan_harian_nonCS.php?Action=Daftar';
            ?>
            <!DOCTYPE html>
            <html>
                <head>
                            ...
                            <div class="sidebar-inner slimscrollleft">
                                ...
                                <div id="sidebar-menu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="laporan_harian_nonCS.php?Action=Detail_Laporan&Tanggal=<?php echo $Tanggal_Laporan ?>" class="waves-effect"><i class="ti-back-left"></i><span> Kembali </span></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="clearfix"></div>
                                    ...
                                    <div class="container">
                                        <div class="panel">
                                            <div class="panel-body">
                                                <form class="form-horizontal" name="form_tambah" action="laporan_harian_nonCS.php" method="post" enctype="multipart/form-data">
                                                ...
                                                <form class="form-horizontal" name="form_tambah" action="laporan_harian_nonCS.php" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-sm-12 col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8 input-group date" >
                                                                <textarea id="inputKeterangan" name="Keterangan" rows=10 cols=50></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="inputFile" class="col-sm-3 ">File</label>
        ...
        elseif($_GET['Action']=='Dokumen_Detail_View')
        {
    ...
    elseif(isset($_POST['Action']))
    {
        if($_POST['Action']=='Dokumen_Siswa_Update' || $_POST['Action']=='Dokumen_Siswa_Tambah')
        {
            if(isset($_POST['submit']))
            {
                ...
                $Jenis_LaporanNID = 7; //Untuk HO dan Operasional
            ...
            ?>
                <script>
                    window.location.href="laporan_harian_nonCS.php?Action=Daftar";
                </script>
            <?php
        }
        if($_POST['Action']=='Dokumen_Detail_Update' || $_POST['Action']=='Dokumen_Detail_Tambah')
        {
            ...
            ?>
                <script>
                    window.location.href="laporan_harian_nonCS.php?Action=Detail_Laporan&Tanggal=<?php echo $Tanggal ?>";
                </script>
            <?php
        }

...
else 
{
    ...
    if(isset($_GET['Action']))
    {
                ...
                <body class="fixed-left">
                            ...
                            <div class="content">
                                ...
                                <div class="">
                                    <div class="page-header-title">
                                        <h4 class="page-title">Pengguna Jasa </h4>
                                    </div>
                                </div>
                                <?php
                                    ...
                                    <div class="container">
                                                            ...
                                                            <div class="col-sm-9 input-group date" >
                                                                ...
                                                                if($Hak_Akses==2)
                                                                {
                                                                    $sql = "SELECT * FROM laporan_harian lh 
                                                                                ...
                                                                                WHERE lh.CabangNID = '".$Filter_Cabang."' AND lj.Jenis_Laporan = 'Pengguna Jasa' 
                                                                                GROUP BY lh.Periode;";
                                                                }
                                                                else
                                                                {
                                                                    $sql = "SELECT * FROM laporan_harian lh 
                                                                                INNER JOIN laporan_jenis lj ON lj.Jenis_LaporanNID = lh.Jenis_LaporanNID
                                                                                WHERE lh.CabangNID = '".$CabangNID."' AND lj.Jenis_Laporan = 'Pengguna Jasa' 
                                                                                GROUP BY lh.Periode;";
                                                                }
                                        ...
                                        <div class="panel">
                                            <div class="panel-body table-responsive">
                                                ...
                                                {
                                                    ?>
                                                    <p><a href="pengguna_jasa.php?Action=Dokumen_Tambah" class="btn btn-info" title="Klik untuk menambah data"><i class="fa fa-plus"></i> Data</a></p>
                                                    <?php
                                                }
                                                else
                                                {
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if($Hak_Akses==2)
                                                        {
                                                            $sql = "SELECT lh.*, count(lh.Tanggal) AS Jumlah_Gambar FROM laporan_harian lh
                                                                        WHERE lh.Jenis_LaporanNID = 5 AND lh.Periode = '".$Tahun_Tanggal."-".$Bulan_Tanggal."'
                                                                                AND lh.CabangNID = '".$Filter_Cabang."'
                                                                        GROUP BY lh.Tanggal
                                                        ...
                                                        while($buff_Data_Siswa = mysqli_fetch_array($qry_Data_Siswa))
                                                        {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align:left"><a href="pengguna_jasa.php?Action=Detail_Laporan&Tanggal=<?php echo $Tanggal_Report ?>"><?php echo $Daftar_Hari[$Hari].", ".date("d-m-Y", $Tanggal_Report_Tampilan) ?></a></td>
                    ...
                    <script>
                        function CekWaktu() 
                        {
                            ...
                            window.location.href="pengguna_jasa.php?Action=Daftar&Periode="+Periode;
                        }
                        function CekCabang() 
                        {
                            var Cabang = document.getElementById("inputCabang").value;
                            
                            window.location.href="pengguna_jasa.php?Action=Daftar&Cabang="+Cabang;
                        }
                ...
                <body class="fixed-left">
                                ...
                                <div id="sidebar-menu">
                                    ...
                                    if($Hak_Akses==1) //Administrator
                                    {
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="pengguna_jasa.php?Action=Daftar" class="waves-effect"><i class="ti-back-left"></i><span> Kembali </span></a>
                                            </li>
                                        </ul>
                                        <?php
                                    }
                                    ...
                                    <div class="container">
                                        <div class="panel">
                                            <div class="panel-body table-responsive">
                                                ...
                                                {
                                                    ?>
                                                    <p><a href="pengguna_jasa.php?Action=Dokumen_Detail_Tambah&Tanggal=<?php echo $Tanggal_Laporan ?>" class="btn btn-info" title="Klik untuk menambah data"><i class="fa fa-plus"></i> Data</a></p>
                                                    <?php
                                                }
                                                else
                                                {
                                                            ...
                                                            <tr>
                                                                ...
                                                                if($Hak_Akses==2)
                                                                {
                                                                    ...
                                                                    <td style="text-align:center">
                                                                        <a href="pengguna_jasa.php?Action=Dokumen_Valid&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>"><i class="fa <?php echo ($IsValid==1)?"fa-check":"fa-times" ?>"></i></a>
                                                                    </td>
                                                                    <?php
                                                                }
                                                                else
                                                                {
                                                                    ?>
                                                                    <td style="text-align:center">
                                                                        <a href="pengguna_jasa.php?Action=Dokumen_Detail_Update&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>"><i class="fa fa-pencil"></i></a>
                                                                        <a href="pengguna_jasa.php?Action=Dokumen_Detail_Hapus&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>" title="Hapus laporan"><i class="fa fa-trash"></i></a>
                                                                    </td>
                                                                    <?php
                                                                }
                    ...
                    <script>
                        function CekWaktu() 
                        {
                            ...
                            window.location.href="pengguna_jasa.php?Action=Daftar&Tanggal="+Tanggal;
                        }
        ...
        elseif($_GET['Action']=='Dokumen_Detail_Hapus')
        {
            ...
            $_SESSION['Parrent_Page'] = 'pengguna_jasa.php?Action=Daftar';
            ?>
            <!DOCTYPE html>
            <html>
                <head>
                            ...
                            <div class="sidebar-inner slimscrollleft">
                                ...
                                <div id="sidebar-menu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="pengguna_jasa.php?Action=Detail_Laporan&Tanggal=<?php echo $Tanggal_Laporan ?>" class="waves-effect"><i class="ti-back-left"></i><span> Kembali </span></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="clearfix"></div>
                                    ...
                                    <div class="container">
                                        <div class="panel">
                                            <div class="panel-body">
                                                <form class="form-horizontal" name="form_tambah" action="pengguna_jasa.php" method="post" enctype="multipart/form-data">
                    ...
                    <div id="wrapper">
                        ...
                        <div class="content-page">
                            ...
                            <div class="content">
                                ...
                                <div class="">
                                    <div class="page-header-title">
                                        <h4 class="page-title"><?php echo (($_GET['Action']=='Dokumen_Update')?"Update":"Tambah") ?> Dokumen PJ </h4>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9 input-group date" >
                                                               ...
                                                               <select name="Waktu" id="inputWaktu" onchange="CekWaktu()" class="form-control">
                                                                    ...
                                                                    <option value="<?php echo $Waktu?>" ><?php echo $Text_Item ?></option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12 col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9 input-group date" >
                                                                ...
                                                                $num = mysqli_num_rows($qry);
                                                                //echo "Filter tanggal ".$Filter_Tanggal."<br>";
                                                                //echo "Tanggal_Laporan tanggal ".$Tanggal_Laporan."<br>";
                                                                $Tanggal = $Tanggal_Laporan;
                                                                $Tanggal = date('Y-m-d');
                                                                $Tanggal_Berjalan = date('Y-m-d');
                                                                $Bulan_Berjalan = intval(date("m"));
                                                                ...
                                                                <select name="Waktu" id="inputWaktu" onchange="CekWaktu()" class="form-control">
                                                                    ...
                                                                    else
                                                                    {
                                                                        while ($buff = mysqli_fetch_array($qry)) 
                                                                        {
                                                                            $Tanggal = $buff['Periode'];
                                                                            $Bulan_Text = $Daftar_Bulan[intval(substr($Tanggal,5,2))];
                                                                            $Tahun_Text = substr($buff['Tanggal'],0,4);
                                                                            $Waktu = $Tahun_Text."-".substr($Tanggal,5,2);
                                                                            $Current_Text_Item = $Bulan_Text." ".$Tahun_Text;
                                                                            if($Waktu_Sebelumnya<>$Waktu)
                                                                            {   
                                                                                if($Tanggal==$Periode_Laporan)
                                                                                {
                                                                                    ?>
                                                                        ...
                                                                        //Cek apakaha periode untuk bulan berjalan ada di database
                                                                        $Tanggal = $Tanggal_Laporan;
                                                                        $Bulan_Text = $Daftar_Bulan[intval(substr($Tanggal,5,2))];
                                                                        $Tahun_Text = substr($Tanggal,0,4);
                                                                        $Text_Item = $Bulan_Text." ".$Tahun_Text;
    ...
    elseif(isset($_POST['Action']))
    {
        if($_POST['Action']=='Dokumen_Siswa_Update' || $_POST['Action']=='Dokumen_Siswa_Tambah')
        {
            if(isset($_POST['submit']))
            {
                ...
                $Jenis_LaporanNID = 5; //Pengguna Jasa
                ...
                elseif($_POST['Action']=='Dokumen_Siswa_Tambah')
                {
                    ...
                    $Image_Before = "";
                    $Image_After = "";
                    $sql = "INSERT INTO laporan_harian(CabangNID, Jenis_LaporanNID, Periode, Tanggal, Image_Before, Image_After, Keterangan, Creator, Create_Date, Last_User) VALUES 
                                ('$CabangNID', '$Jenis_LaporanNID', '$Periode', '$Tanggal', '$Image_Before', '$Image_After', '$Keterangan', '$Last_UserNID', now(), '$Last_UserNID') ";
                    //echo $sql.";<br>";
                    $qry = mysqli_query($Connection, $sql);
            ...
            ?>
                <script>
                    window.location.href="pengguna_jasa.php?Action=Daftar";
                </script>
            <?php
        }
        if($_POST['Action']=='Dokumen_Detail_Update' || $_POST['Action']=='Dokumen_Detail_Tambah')
        {
            if(isset($_POST['submit']))
            {
                ...
                elseif($_POST['Action']=='Dokumen_Detail_Tambah')
                {
                    ...
                    $Image_Before = "";
                    $Image_After = "";
                    $sql = "INSERT INTO laporan_harian(CabangNID, Periode, Jenis_LaporanNID, Tanggal, Image_Before, Image_After, Keterangan, Creator, Create_Date, Last_User) VALUES 
                                ('$CabangNID', '$Periode', '$Jenis_LaporanNID', '$Tanggal', '$Image_Before', '$Image_After', '$Keterangan', '$Last_UserNID', now(), '$Last_UserNID') ";
                    //echo $sql.";<br>";
                    $qry = mysqli_query($Connection, $sql);
                    $Laporan_HarianNID = mysqli_insert_id($Connection);
            ...
            ?>
                <script>
                    window.location.href="pengguna_jasa.php?Action=Detail_Laporan&Tanggal=<?php echo $Tanggal ?>";
                </script>
            <?php
        }

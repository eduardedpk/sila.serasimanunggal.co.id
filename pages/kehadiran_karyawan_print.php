                            ...
                            <div class="sidebar-inner slimscrollleft">
                                ...
                                <div id="sidebar-menu">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="kehadiran_karyawan.php?Action=Rekap" class="waves-effect"><i class="ti-back-left"></i><span> Kembali </span></a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="content">
                                ...
                                <div class="">
                                    <div class="page-header-title">
                                        <h4 class="page-title">Cetak Rekap Absensi Karyawan</h4>
                                    </div>
                                </div>
                                    ...
                                    <div class="container">
                                        <div class="panel">
                                            <div class="panel-body">
                                                <div class="row">
                                                    <form class="form-horizontal" name="form_tambah" action="kehadiran_karyawan_print.php" method="post" enctype="multipart/form-data">
                                                        <input id='Filter_Tanggal_Rekap_Karyawan' type="hidden" name="Action" value="Cetak">
                                                        <input id='Finger_PrintNID' type="hidden" name="Finger_PrintNID" value="<?php echo $Finger_PrintNID ?>">
                                                        <div class="col-sm-6 col-lg-6">
                                                            <div class="form-group">
                                                                <label for="FilterTahun" class="col-sm-4 control-label">Jenis Report</label>
                                                                
                                                                <div class="col-sm-8 input-group date" >
                                                                    <select class="form-control" name="FilterTahun" id="FilterTahun">
                                                                        <option value=1> Rekap Karyawan Harian</option>
                                                                        <option value=2> Rekap Karyawan Per Bulan</option>
                                                                        <option value=2> Rekap Rincian Per Bulan</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div class="sidebar-inner slimscrollleft">
                                ...
                                <div id="sidebar-menu">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="kehadiran_karyawan.php?Action=Print" class="waves-effect"><i class="ti-printer"></i><span> Print </span></a>
                                        </li>
                                        <li>

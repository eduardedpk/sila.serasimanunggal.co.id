...
else 
{
    ...
    if(isset($_GET['Action']))
    {
                ...
                <body class="fixed-left">
                            ...
                            <div class="content">
                                ...
                                <div class="">
                                    <div class="page-header-title">
                                        <h4 class="page-title">Inspeksi Area </h4>
                                    </div>
                                </div>
                                <?php
                                    ...
                                    <div class="container">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9 input-group date" >
                                                                ...
                                                                if($Hak_Akses==2)
                                                                {
                                                                    $sql = "SELECT * FROM laporan_harian lh 
                                                                                INNER JOIN laporan_jenis lj ON lj.Jenis_LaporanNID = lh.Jenis_LaporanNID
                                                                                WHERE lh.CabangNID = '".$Filter_Cabang."' AND lj.Jenis_Laporan = 'Inspeksi Area'  
                                                                                GROUP BY year(lh.Tanggal), month(lh.Tanggal);";
                                                                }
                                                                else
                                                                {
                                                                    $sql = "SELECT * FROM laporan_harian lh 
                                                                                INNER JOIN laporan_jenis lj ON lj.Jenis_LaporanNID = lh.Jenis_LaporanNID
                                                                                WHERE lh.CabangNID = '".$CabangNID."' AND lj.Jenis_Laporan = 'Inspeksi Area'   
                                                                                GROUP BY year(lh.Tanggal), month(lh.Tanggal);";
                                                                }
                                        ...
                                        <div class="panel">
                                            <div class="panel-body table-responsive">
                                                ...
                                                {
                                                    ?>
                                                    <p><a href="inspeksi_area.php?Action=Dokumen_Tambah" class="btn btn-info" title="Klik untuk menambah data"><i class="fa fa-plus"></i> Data</a></p>
                                                    <?php
                                                }
                                                else
                                                {
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if($Hak_Akses==2)
                                                        {
                                                            $sql = "SELECT lh.*, count(lh.Tanggal) AS Jumlah_Gambar FROM laporan_harian lh
                                                                        WHERE lh.Jenis_LaporanNID = 3 AND
                                                        ...
                                                        while($buff_Data_Siswa = mysqli_fetch_array($qry_Data_Siswa))
                                                        {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align:left"><a href="inspeksi_area.php?Action=Detail_Laporan&Tanggal=<?php echo $Tanggal_Report ?>"><?php echo $Daftar_Hari[$Hari].", ".date("d-m-Y", $Tanggal_Report_Tampilan) ?></a></td>
                    ...
                    <script>
                        function CekWaktu() 
                        {
                            ...
                            window.location.href="inspeksi_area.php?Action=Daftar&Tanggal="+Tanggal;
                        }
                        function CekCabang() 
                        {
                            var Cabang = document.getElementById("inputCabang").value;
                            
                            window.location.href="inspeksi_area.php?Action=Daftar&Cabang="+Cabang;
                        }
                                ...
                                <div id="sidebar-menu">
                                    ...
                                    if($Hak_Akses==1) //Administrator
                                    {
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="inspeksi_area.php?Action=Daftar" class="waves-effect"><i class="ti-back-left"></i><span> Kembali </span></a>
                                            </li>
                                        </ul>
                                        <?php
                                    }
                                    ...
                                    <div class="container">
                                        <div class="panel">
                                            <div class="panel-body table-responsive">
                                                ...
                                                {
                                                    ?>
                                                    <p><a href="inspeksi_area.php?Action=Dokumen_Detail_Tambah&Tanggal=<?php echo $Tanggal_Laporan ?>" class="btn btn-info" title="Klik untuk menambah data"><i class="fa fa-plus"></i> Data</a></p>
                                                    <?php
                                                }
                                                else
                                                {
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if($Hak_Akses==2)
                                                        {
                                                            ...
                                                            $sql = "SELECT lh.* FROM laporan_harian lh
                                                                        WHERE lh.Jenis_LaporanNID = 3 AND lh.CabangNID = ".$Filter_Cabang."
                                                            ...
                                                            <tr>
                                                                ...
                                                                if($Hak_Akses==2)
                                                                {
                                                                    ...
                                                                    <td style="text-align:center">
                                                                        <a href="inspeksi_area.php?Action=Dokumen_Valid&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>"><i class="fa <?php echo ($IsValid==1)?"fa-check":"fa-times" ?>"></i></a>
                                                                    </td>
                                                                    <?php
                                                                }
                                                                else
                                                                {
                                                                    ?>
                                                                    <td style="text-align:center">
                                                                        <a href="inspeksi_area.php?Action=Dokumen_Detail_Update&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>"><i class="fa fa-pencil"></i></a>
                                                                        <a href="inspeksi_area.php?Action=Dokumen_Detail_Hapus&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>" title="Hapus laporan"><i class="fa fa-trash"></i></a>
                                                                    </td>
                                                                    <?php
                                                                }
        ...
        elseif($_GET['Action']=='Dokumen_Detail_Hapus')
        {
            ...
            $_SESSION['Parrent_Page'] = 'inspeksi_area.php?Action=Daftar';
            ?>
            <!DOCTYPE html>
            <html>
                <head>
                            ...
                            <div class="sidebar-inner slimscrollleft">
                                ...
                                <div id="sidebar-menu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="inspeksi_area.php?Action=Detail_Laporan&Tanggal=<?php echo $Tanggal_Laporan ?>" class="waves-effect"><i class="ti-back-left"></i><span> Kembali </span></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="clearfix"></div>
                                    ...
                                    <div class="container">
                                        <div class="panel">
                                            <div class="panel-body">
                                                <form class="form-horizontal" name="form_tambah" action="inspeksi_area.php" method="post" enctype="multipart/form-data">
        ...
        if($_POST['Action']=='Dokumen_Siswa_Update' || $_POST['Action']=='Dokumen_Siswa_Tambah')
        {
            if(isset($_POST['submit']))
            {
                ...
                if(date("Y-m-d H:i:s") < $Batas_Waktu)
                {
                    ...
                    $Jenis_LaporanNID = 3; //Inspeksi Area
                    ...
                    ?>
                        <script>
                            window.location.href="inspeksi_area.php?Action=Daftar";
                        </script>
                    <?php
                }
                else
                {
                    ?>
                        <script>
                            window.location.href="inspeksi_area.php?Action=Dokumen_Tambah&Alert=true";
                        </script>
                    <?php
                }
        ...
        if($_POST['Action']=='Dokumen_Detail_Update' || $_POST['Action']=='Dokumen_Detail_Tambah')
        {
            if(isset($_POST['submit']))
            {
                ...
                if(date("Y-m-d H:i:s") < $Batas_Waktu)
                {
                    ...
                    ?>
                        <script>
                            window.location.href="inspeksi_area.php?Action=Detail_Laporan&Tanggal=<?php echo $Tanggal ?>";
                        </script>
                    <?php
                }
                else
                {
                    if($_POST['Action']=='Dokumen_Detail_Update')
                    {
                        ...
                        ?>
                            <script>
                                window.location.href="inspeksi_area.php?Action=Dokumen_Detail_Update&Tanggal=<?php echo $Tanggal ?>&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>&Alert=true";
                            </script>
                        <?php
                    }
                    else
                    {
                        ?>
                            <script>
                                window.location.href="inspeksi_area.php?Action=Dokumen_Detail_Tambah&Tanggal=<?php echo $Tanggal ?>&Alert=true";
                            </script>
                        <?php
                    }

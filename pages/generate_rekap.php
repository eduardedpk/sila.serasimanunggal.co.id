                ...
                while($buff_Data = mysqli_fetch_array($qry_Data))
                {
                        ...
                        $CabangNID==15 || $CabangNID==16)      //Sidoarjo 1(15) dan Sidoarjo 2(16)
                    {
                        ...
                        if($CabangNID==41 || $CabangNID==42 )
                        {
                            ...
                            $sql = "SELECT * FROM laporan_harian lh
                                        WHERE lh.Jenis_LaporanNID = 2 AND lh.CabangNID = 41 AND year(lh.Tanggal) = '".$Tahun_Periode."' AND month(lh.Tanggal) = '".$Bulan_Periode."' AND lh.Tanggal IN (".$Daftar_Tanggal_Masuk.")
                                        AND lh.IsValid = 1  AND lh.Cuti=0
                                        GROUP BY lh.Tanggal
                                        ";
                            //echo $sql.";<br>";
                            ...
                            if($Jumlah_CT>=$Jumlah_Maksimal_Hari_Aktif)
                            {
                                $Score_CT = 5;
                            }
                            elseif($Jumlah_CT>=($Jumlah_Maksimal_Hari_Aktif-1))
                            {
                                $Score_CT = 4;
                            }
                            elseif($Jumlah_CT>=($Jumlah_Maksimal_Hari_Aktif-2))
                            {
                                $Score_CT = 3;
                            }
                            elseif($Jumlah_CT>=($Jumlah_Maksimal_Hari_Aktif-3))
                            {
                                $Score_CT = 2;
                            }
                            elseif($Jumlah_CT>=($Jumlah_Maksimal_Hari_Aktif-4))
                            {
                                $Score_CT = 1;
                            }
                            elseif($Jumlah_CT>=1)
                            ...
                            //Ambil data CT Bandung 1
                            $sql = "SELECT * FROM laporan_harian lh
                                        WHERE lh.Jenis_LaporanNID = 2 AND lh.CabangNID = 42 AND year(lh.Tanggal) = '".$Tahun_Periode."' AND month(lh.Tanggal) = '".$Bulan_Periode."' AND lh.Tanggal IN (".$Daftar_Tanggal_Masuk.")
                                        AND lh.IsValid = 1  AND lh.Cuti=0
                                        GROUP BY lh.Tanggal
                                        ";
                            //echo $sql.";<br>";
                        ...
                        elseif($CabangNID==3 || $CabangNID==12)
                        {
                            ...
                            //Ambil data CT Bandung 1
                            $sql = "SELECT * FROM laporan_harian lh
                                        WHERE lh.Jenis_LaporanNID = 2 AND lh.CabangNID = 3 AND year(lh.Tanggal) = '".$Tahun_Periode."' AND month(lh.Tanggal) = '".$Bulan_Periode."' AND lh.Tanggal IN (".$Daftar_Tanggal_Masuk.")
                                        AND lh.IsValid = 1  AND lh.Cuti=0
                                        GROUP BY lh.Tanggal
                                        ";
                            //echo $sql.";<br>";
                            ...
                            //Ambil data CT Bandung 1
                            $sql = "SELECT * FROM laporan_harian lh
                                        WHERE lh.Jenis_LaporanNID = 2 AND lh.CabangNID = 12 AND year(lh.Tanggal) = '".$Tahun_Periode."' AND month(lh.Tanggal) = '".$Bulan_Periode."' AND lh.Tanggal IN (".$Daftar_Tanggal_Masuk.")
                                        AND lh.IsValid = 1  AND lh.Cuti=0
                                        GROUP BY lh.Tanggal
                                        ";
                            //echo $sql.";<br>";
                        ...
                        elseif($CabangNID==35 || $CabangNID==36)
                        {
                            ...
                            $sql = "SELECT * FROM laporan_harian lh
                                        WHERE lh.Jenis_LaporanNID = 2 AND lh.CabangNID = 35 AND year(lh.Tanggal) = '".$Tahun_Periode."' AND month(lh.Tanggal) = '".$Bulan_Periode."' AND lh.Tanggal IN (".$Daftar_Tanggal_Masuk.")
                                        AND lh.IsValid = 1  AND lh.Cuti=0
                                        GROUP BY lh.Tanggal
                                        ";
                            //echo $sql.";<br>";
                            ...
                            $sql = "SELECT * FROM laporan_harian lh
                                        WHERE lh.Jenis_LaporanNID = 2 AND lh.CabangNID = 36 AND year(lh.Tanggal) = '".$Tahun_Periode."' AND month(lh.Tanggal) = '".$Bulan_Periode."' AND lh.Tanggal IN (".$Daftar_Tanggal_Masuk.")
                                        AND lh.IsValid = 1  AND lh.Cuti=0
                                        GROUP BY lh.Tanggal
                                        ";
                            //echo $sql.";<br>";
                        ...
                        elseif($CabangNID==4 || $CabangNID==5)
                        {
                            ...
                            //Ambil data CT Bandung 1
                            $sql = "SELECT * FROM laporan_harian lh
                                        WHERE lh.Jenis_LaporanNID = 2 AND lh.CabangNID = 4 AND year(lh.Tanggal) = '".$Tahun_Periode."' AND month(lh.Tanggal) = '".$Bulan_Periode."' AND lh.Tanggal IN (".$Daftar_Tanggal_Masuk.")
                                        AND lh.IsValid = 1  AND lh.Cuti=0
                                        GROUP BY lh.Tanggal
                                        ";
                            //echo $sql.";<br>";
                            ...
                            //Ambil data CT Bandung 1
                            $sql = "SELECT * FROM laporan_harian lh
                                        WHERE lh.Jenis_LaporanNID = 2 AND lh.CabangNID = 5 AND year(lh.Tanggal) = '".$Tahun_Periode."' AND month(lh.Tanggal) = '".$Bulan_Periode."' AND lh.Tanggal IN (".$Daftar_Tanggal_Masuk.")
                                        AND lh.IsValid = 1  AND lh.Cuti=0
                                        GROUP BY lh.Tanggal
                                        ";
                            //echo $sql.";<br>";
                        ...
                        elseif($CabangNID==15 || $CabangNID==16)
                        {
                            ...
                            //Ambil data CT Bandung 1
                            $sql = "SELECT * FROM laporan_harian lh
                                        WHERE lh.Jenis_LaporanNID = 2 AND lh.CabangNID = 15 AND year(lh.Tanggal) = '".$Tahun_Periode."' AND month(lh.Tanggal) = '".$Bulan_Periode."' AND lh.Tanggal IN (".$Daftar_Tanggal_Masuk.")
                                        AND lh.IsValid = 1  AND lh.Cuti=0
                                        GROUP BY lh.Tanggal
                                        ";
                            //echo $sql.";<br>";
                            ...
                            //Ambil data CT Bandung 1
                            $sql = "SELECT * FROM laporan_harian lh
                                        WHERE lh.Jenis_LaporanNID = 2 AND lh.CabangNID = 16 AND year(lh.Tanggal) = '".$Tahun_Periode."' AND month(lh.Tanggal) = '".$Bulan_Periode."' AND lh.Tanggal IN (".$Daftar_Tanggal_Masuk.")
                                        AND lh.IsValid = 1  AND lh.Cuti=0
                                        GROUP BY lh.Tanggal
                                        ";
                            //echo $sql.";<br>";
                    ...
                    else
                    {
                        //Ambil data CT
                        $sql = "SELECT * FROM laporan_harian lh
                                    WHERE lh.Jenis_LaporanNID = 2 AND lh.CabangNID = '".$CabangNID."' AND year(lh.Tanggal) = '".$Tahun_Periode."' AND month(lh.Tanggal) = '".$Bulan_Periode."' AND lh.Tanggal IN (".$Daftar_Tanggal_Masuk.")
                                        AND lh.IsValid = 1  AND lh.Cuti=0
                                        GROUP BY lh.Tanggal
                                        ";
                        //echo $sql.";<br>";

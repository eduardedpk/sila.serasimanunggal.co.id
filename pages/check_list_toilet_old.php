                ...
                <body class="fixed-left">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if($Hak_Akses==2)
                                                        {
                                                            $sql = "SELECT lh.*, count(lh.Tanggal) AS Jumlah_Gambar FROM laporan_harian lh
                                                                        WHERE lh.Jenis_LaporanNID = 2 AND lh.Periode = '".$Tahun_Tanggal."-".$Bulan_Tanggal."'
                    ...
                    <script>
                        function CekWaktu() 
                        {
                            ...
                            //alert(Tanggal);
                            window.location.href="check_list_toilet.php?Action=Daftar&Periode="+Tanggal;
                        }
                        function CekCabang() 
                        {

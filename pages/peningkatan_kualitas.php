...
else 
{
    ...
    if(isset($_GET['Action']))
    {
                ...
                <body class="fixed-left">
                            ...
                            <div class="content">
                                ...
                                <div class="">
                                    <div class="page-header-title">
                                        <h4 class="page-title">Peningkatan Kualitas </h4>
                                    </div>
                                </div>
                                <?php
                                    ...
                                    <div class="container">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9 input-group date" >
                                                                ...
                                                                $sql = "SELECT * FROM laporan_harian lh 
                                                                            ...
                                                                            WHERE lh.CabangNID = '".$CabangNID."' AND lj.Jenis_Laporan = 'Peningkatan Kualitas' 
                                        ...
                                        <div class="panel">
                                            <div class="panel-body table-responsive">
                                                ...
                                                {
                                                    ?>
                                                    <p><a href="peningkatan_kualitas.php?Action=Dokumen_Tambah" class="btn btn-info" title="Klik untuk menambah data"><i class="fa fa-plus"></i> Data</a></p>
                                                    <?php
                                                }
                                                else
                                                {
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if($Hak_Akses==2)
                                                        {
                                                            $sql = "SELECT lh.*, count(lh.Tanggal) AS Jumlah_Gambar FROM laporan_harian lh
                                                                        WHERE lh.Jenis_LaporanNID = 4 AND
                                                        ...
                                                        while($buff_Data_Siswa = mysqli_fetch_array($qry_Data_Siswa))
                                                        {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align:left"><a href="peningkatan_kualitas.php?Action=Detail_Laporan&Tanggal=<?php echo $Tanggal_Report ?>"><?php echo $Daftar_Hari[$Hari].", ".date("d-m-Y", $Tanggal_Report_Tampilan) ?></a></td>
                    ...
                    <script>
                        function CekWaktu() 
                        {
                            ...
                            window.location.href="peningkatan_kualitas.php?Action=Daftar&Tanggal="+Tanggal;
                        }
                    ...
                    <div id="wrapper">
                                ...
                                <div id="sidebar-menu">
                                    ...
                                    if($Hak_Akses==1) //Administrator
                                    {
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="peningkatan_kualitas.php?Action=Daftar" class="waves-effect"><i class="ti-back-left"></i><span> Kembali </span></a>
                                            </li>
                                        </ul>
                                        <?php
                                    }
                        ...
                        <div class="content-page">
                            ...
                            <?php
                                ...
                                <div class="">
                                    <div class="page-header-title">
                                        <h4 class="page-title">Peningkatan Kualitas <?php echo $Daftar_Hari[$Hari].", ".date("d-m-Y", $Tanggal_Report_Tampilan) ?></h4>
                                    </div>
                                </div>
                                    ...
                                    <div class="container">
                                        <div class="panel">
                                            <div class="panel-body table-responsive">
                                                ...
                                                {
                                                    ?>
                                                    <p><a href="peningkatan_kualitas.php?Action=Dokumen_Detail_Tambah&Tanggal=<?php echo $Tanggal_Laporan ?>" class="btn btn-info" title="Klik untuk menambah data"><i class="fa fa-plus"></i> Data</a></p>
                                                    <?php
                                                }
                                                else
                                                {
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if($Hak_Akses==2)
                                                        {
                                                            ...
                                                            $sql = "SELECT lh.* FROM laporan_harian lh
                                                                        WHERE lh.Jenis_LaporanNID = 4 AND lh.CabangNID = ".$Filter_Cabang."
                                                        ...
                                                        {
                                                            $sql = "SELECT lh.* FROM laporan_harian lh
                                                                        WHERE lh.Jenis_LaporanNID = 4 AND lh.CabangNID = ".$CabangNID."
                                                                                AND year(lh.Tanggal) = '".$Tahun_Tanggal."'  AND month(lh.Tanggal) = '".$Bulan_Tanggal."' AND lh.Tanggal = '".$Tanggal_Laporan."'
                                                                        ";
                                                        }
                                                        //echo $sql.";<br>";
                                                            ...
                                                            <tr>
                                                                ...
                                                                if($Hak_Akses==2)
                                                                {
                                                                    ...
                                                                    <td style="text-align:center">
                                                                        <a href="peningkatan_kualitas.php?Action=Dokumen_Valid&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>"><i class="fa <?php echo ($IsValid==1)?"fa-check":"fa-times" ?>"></i></a>
                                                                    </td>
                                                                    <?php
                                                                }
                                                                else
                                                                {
                                                                    ?>
                                                                    <td style="text-align:center">
                                                                        <a href="peningkatan_kualitas.php?Action=Dokumen_Detail_Update&Laporan_HarianNID=<?php echo $Laporan_HarianNID ?>"><i class="fa fa-pencil"></i></a>
                                                                    </td>
                                                                    <?php
                                                                }
        ...
        elseif($_GET['Action']=='Dokumen_Update' || $_GET['Action']=='Dokumen_Tambah')
        {
            ...
            $_SESSION['Parrent_Page'] = 'peningkatan_kualitas.php?Action=Daftar';
            ?>
            <!DOCTYPE html>
            <html>
                <head>
                                    ...
                                    <div class="container">
                                        <div class="panel">
                                            <div class="panel-body">
                                                <form class="form-horizontal" name="form_tambah" action="peningkatan_kualitas.php" method="post" enctype="multipart/form-data">
                                                    <?php 
                                                    if($Action=="Dokumen_Tambah")
                                                    {
                                                        ?>
                            ...
                            <div class="sidebar-inner slimscrollleft">
                                ...
                                <div id="sidebar-menu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="peningkatan_kualitas.php?Action=Detail_Laporan&Tanggal=<?php echo $Tanggal_Laporan ?>" class="waves-effect"><i class="ti-back-left"></i><span> Kembali </span></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="clearfix"></div>
    ...
    elseif(isset($_POST['Action']))
    {
        if($_POST['Action']=='Dokumen_Siswa_Update' || $_POST['Action']=='Dokumen_Siswa_Tambah')
        {
            if(isset($_POST['submit']))
            {
                ...
                $Jenis_LaporanNID = 4; //Peningkatan Kualitas
            ...
            ?>
                <script>
                    window.location.href="peningkatan_kualitas.php?Action=Daftar";
                </script>
            <?php
        }
        if($_POST['Action']=='Dokumen_Detail_Update' || $_POST['Action']=='Dokumen_Detail_Tambah')
        {
            ...
            ?>
                <script>
                    window.location.href="peningkatan_kualitas.php?Action=Detail_Laporan&Tanggal=<?php echo $Tanggal ?>";
                </script>
            <?php
        }
